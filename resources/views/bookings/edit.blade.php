                        ...
                        <div class="card shadow mb-3">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_lengkap" class="form-control" value="{{ $booking->buyer->nama_lengkap  }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="alamat">Alamat</label>
                                    <input type="text" name="alamat" class="form-control" value="{{ $booking->buyer->alamat }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="kota">Kota</label>
                                    <input type="text" name="kota" class="form-control" value="{{ $booking->buyer->kota }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="tanggal_lahir">Tanggal Lahir</label>
                                    <input type="date" name="tanggal_lahir" class="form-control" value="{{ $booking->buyer->tanggal_lahir }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="nik">NIK</label>
                                    <input type="number" name="nik" class="form-control" value="{{ $booking->buyer->nik }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="npwp">NPWP</label>
                                    <input type="number" name="npwp" class="form-control" value="{{ $booking->buyer->npwp }}">
                                </div>
                                <div class="form-group">
                                    <label for="bpjs">BPJS</label>
                                    <input type="number" name="bpjs" class="form-control" value="{{ $booking->buyer->bpjs }}">
                                </div>
                                <div class="form-group">
                                    <label for="no_telp">No. Telepon</label>
                                    <input type="number" name="no_telp" class="form-control" value="{{ $booking->buyer->no_telp }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input type="email" name="email" class="form-control" value="{{ $booking->buyer->email }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_lengkap_istri" class="form-control" value="{{  $booking->spouse->nama_lengkap }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="alamat_istri">Alamat</label>
                                    <input type="text" name="alamat_istri" class="form-control" value="{{  $booking->spouse->alamat }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="kota_istri">Kota/Kabupaten</label>
                                    <input type="text" name="kota_istri" class="form-control" value="{{  $booking->spouse->kota }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="tanggal_lahir_istri">Tanggal Lahir</label>
                                    <input type="date" name="tanggal_lahir_istri" class="form-control" value="{{  $booking->spouse->tanggal_lahir }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="nik_istri">NIK</label>
                                    <input type="number" name="nik_istri" class="form-control" value="{{  $booking->spouse->nik }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow mb-3">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_marketing" class="form-control" value="{{ $booking->nama_marketing }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="property_id">Nama Marketing</label>
                                    <input type="text" name="property_id" class="form-control" value="{{ $booking->property_id }}" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="blok" id="blok" class="form-control" value="{{ $booking->blok }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="type">Type</label>
                                    <input type="text" name="type" id="type" class="form-control" value="{{ $booking->type }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="luas_tanah">Luas Tanah (m2)</label>
                                    <input type="text" name="luas_tanah" id="luas_tanah" class="form-control" value="{{ $booking->luas_tanah }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="luas_bangunan">Luas Bangunan (m2)</label>
                                    <input type="text" name="luas_bangunan" id="luas_bangunan" class="form-control" value="{{ $booking->luas_bangunan }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="hoek">Hoek</label>
                                    <input type="text" name="hoek" id="hoek" class="form-control" value="{{ $booking->hoek }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="harga">Harga</label>
                                    <input type="number" name="harga" id="harga" class="form-control" value="{{ $booking->harga }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="penawaran_harga">Penawaran Harga</label>
                                    <input type="number" name="penawaran_harga" class="form-control" value="{{ $booking->penawaran_harga }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="biaya_booking">Biaya Booking</label>
                                    <input type="number" name="biaya_booking" class="form-control" value="{{ $booking->biaya_booking }}" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="keterangan" class="form-control">{{ $booking->keterangan }}</textarea>
                                </div>
